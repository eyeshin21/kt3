...
Shader "Toony Colors Pro 2/User/TestOutline"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		struct v2f_outline
		{
			...
			float4 pack1 : TEXCOORD1; /* pack1.xyz = worldPos  pack1.w = ndl */
			UNITY_VERTEX_INPUT_INSTANCE_ID
...
/* TCP_DATA u config(ver:"2.9.10";unity:"2022.3.36f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","OUTLINE","SPEC_PBR_GGX","SPECULAR","OUTLINE_LIGHTING_VERT","OUTLINE_LIGHTING","ENABLE_DECALS","ENABLE_DEPTH_NORMALS_PASS","ENABLE_COOKIES","SPECULAR_NO_ATTEN","SPECULAR_SHADER_FEATURE","SHADOW_COLOR_MAIN_DIR","ENABLE_SHADOW_2ND_LIGHTS","TEMPLATE_LWRP","SHADOW_HSV"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 199bef8922efe56e647768b87540bd7d */
